...
public class Tupel<T extends Comparable<T>, V extends Comparable<V>>
		implements Comparable<Tupel<T, V>> {
	protected T t;
	protected V v;
	...
	public static <T extends Comparable<T>, V extends Comparable<V>> 
				  Tupel<T, V> create(T t, V v) {
